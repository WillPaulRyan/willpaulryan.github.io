  ...
  render() {
    ...
    return (
      <div className="project" >
        <img ref={this.imgRef} style={bgPosition} onMouseMove={this.handleMouseMove} src={this.props.pic} alt={this.props.name} />
        <h4 className="name project-text">{this.props.name}</h4>
        <p className="description project-text">{this.props.description}</p>
        <a href={this.props.url} className="url project-text" target="_blank" rel="noopener noreferrer">Live Site</a>
        <a href={this.props.github} className="github project-text">Github</a>
      </div>
    );
  }
}
