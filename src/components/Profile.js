...
class Profile extends React.Component {
  render () {
    return (
      <div id="profile">
        <img id="profile-header" src='/images/low_poly_bg.png' alt='background'/>
        <h1>Will Ryan III</h1>
